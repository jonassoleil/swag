...
class ConvBlock(nn.Module):
    """
    Simple 5x5 conv with padding size 1 (to leave the input size unchanged), followed by a ReLU.
    """

    def __init__(self, input_channels: int, output_channels: int) -> None:
        super().__init__()
        self.conv = nn.Conv2d(input_channels, output_channels, kernel_size=5, stride=1, padding=2)
        self.relu = nn.ReLU()
...
class CNN(nn.Module):
    ...
    def __init__(self, data_config: Dict[str, Any], args: argparse.Namespace = None) -> None:
        ...
        # Because our 5x5 convs have padding size 2, they leave the input size unchanged.
